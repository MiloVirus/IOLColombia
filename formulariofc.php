...
<body>
	...
	<div class="container-fluid formulario">	
		<div class="container todo">
			...
			<form id="daform" action="enviofc.php" method="POST">
<h1>InscríbeteYA</h1>
				...
				<div><input name="genero" type="checkbox" value="hombre">Hombre
					...
					<br>
					<ul>
						<li><input type="image" onclick="submitForm('enviofc.php')" name="input1" src="imagenes/llama.png" value="Submit1" width="48" height="48"></li>
						<li>Enviar y recibir llamada</li>
						<li><input type="image" onclick="submitForm('enviofc.php')" name="input2" src="imagenes/correo.png" value="Submit2" width="48" height="48"></li>
						<li>Solo Enviar</li>
					</ul>
				</form>
			</div><!-- CIERRE TODO -->
