...
<body>
	...
	<div class="container-fluid formulario">	
		<div class="container todo">
			...
			<form id="daform" action="envioConversatorioPDI.php" method="POST" onSubmit="submitForm()">
<h1>InscríbeteYA</h1>
					...
					<select class="estilo" name="id_curso">
						<option value="">Conversatorio Periodismo Deportivo Internacional</option>
					</select>
					<br>
					<br>
				<div><input name="genero" type="checkbox" value="hombre">Hombre
					...
					<br>
					<ul>
						<li><input type="image" value="Submit"  name="input2" src="imagenes/correo.png" width="48" height="48"></li>
						<li>Enviar</li>
					</ul>
				</form>
			</div><!-- CIERRE TODO -->
